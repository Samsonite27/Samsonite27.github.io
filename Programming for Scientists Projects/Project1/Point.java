...
public class Point {
    ...
    */
     ...
     */   
    public double getX() {
    	// Returns the X variable for this class 
        return X;
    }
     ...
     */   
    public double getY() {
	    // Returns the y variable for this class
        return Y;
    }
    ...
    public double distance(Point x) {
        double distance = Math.sqrt((Math.pow(((x.getX()) - X), 2) + Math.pow(((x.getY()) -  Y), 2)));
        return distance;
    }
    ...
    public static void main (String args[]) {
        Point point_one = new Point(1,2);
        Point point_two = new Point(2,2);
        System.out.println(point_two.distance(point_one));
    } 
}
